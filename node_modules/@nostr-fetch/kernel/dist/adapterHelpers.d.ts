...
import { FetchTillEoseOptions } from "./fetcherBackend";
 ...
 * ```
 */
export declare const setupSubscriptionAbortion: (closeSub: () => void, tx: ChannelSender<NostrEvent>, options: FetchTillEoseOptions) => (() => void);
